...
For example:
eval `bbs_build_env -u dbg_64_cpp20 -p gcc-10`   # set the environment
                                                 # (debug, 64-bit, C++20 build, gcc-10)

eval `bbs_build_env unset`                       # unset the environment

bbs_build_env list                               # list available compilers
