...
The \ **sim_cpp11_features.py**\  program converts a file with specially
...
``BdeBuildSystem/scripts/sim_cpp11_features.py`` and is intended to be invoked
...
\ **Usage:**\  \ ``sim_cpp11_features.py``\  [ \ *option...*\  ] \ *input-file-name...*\
...
.. code-block:: cpp
     ...
     // Command line: sim_cpp11_features.py foo.h
