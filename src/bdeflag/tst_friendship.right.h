...
Warning: tst_friendship.h: (42, 0): class name txt_friendShipabc_Klass5 begins with 't' -- not an upper case char
Warning: tst_friendship.h: (42, 0): class name txt_friendShipabc_Klass5 doesn't start with the component name
