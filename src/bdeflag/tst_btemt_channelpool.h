...
// 'txtbtemtnnelPool::KeepHalfOpenMode') to 'close', 'import', or 'listen' has
...
//          // occurred.  If 'state' is 'txtbtemtnnelPool::BTEMT_CHANNEL_DOWN'
...
//          // 'txtbtemtnnelPool::ChannelState' enumeration value, and 'ctx'
