...
F<BdeBuildSystem/scripts/sim_cpp11_features.pl>.
...
// ----------------------------- END-OF-FILE ----------------------------------
EOT
chomp $bottomCopyright;  # No trailing newlines on substitution elements
...
sub filenameToBoilerplate($) {
    ...
    my %substitutions = (
        ...
        qr/<bottomCopyright>/             => $bottomCopyright,
        qr/<topCopyright>/                => $topCopyright,
        );
...
sub writeExpansion($$)
{
    ...
    if (open OLD_FILE, "<$outputFilename") {
        ...
        if ($outputCopy eq $originalFileData) {
...
sub processFile($$)
{
    ...
    #
    # This includes supporting leading copyright blocks.
    if ($fileData =~ m!
            (\n?
             //[ ]--+\n
        ...
        $bottomCopyright = $1;
        $topCopyright = "";
        debug("Copyright (bottom of file) is now\n$bottomCopyright")
    }
    elsif ($fileData =~ m!^\n*
             (
        ...
        $bottomCopyright = "";
        $topCopyright = $1;
        debug("Copyright (top of file) is now\n$topCopyright")
    }
    else {
