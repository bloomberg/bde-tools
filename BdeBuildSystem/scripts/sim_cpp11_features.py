...
def usage(message: str) -> None:
    ...
    print(f"""{message}
Usage: sim_cpp11_features.py [ --output=<filename> ]
                             [ --var-args=<max-args> ]
                             [ --debug=<level> ]
...
def transform_file(params: Params, command_line: str, initial_data: str, gen_master: bool) -> str:
    ...
    while True:
        ...
        if params.clean:
            ...
            output += "#   error sim_cpp11_features.py has not been run\n"
...
// the 'sim_cpp11_features.py' program.  If the original test driver contains
