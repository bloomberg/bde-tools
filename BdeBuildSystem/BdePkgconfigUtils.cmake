...
macro(_pkgconfig_map_insert uor_name pc_name)
    set(_bbs_uor_to_pkgconfig_map_${uor_name} ${pc_name} CACHE INTERNAL "")
    set(_bbs_pkgconfig_to_uor_map_${pc_name} ${uor_name} CACHE INTERNAL "")
endmacro()
...
function(bbs_uor_to_pc_name uor_name pc_name)
    ...
    if(DEFINED _bbs_uor_to_pkgconfig_map_${uor_name})
        set(${pc_name} ${_bbs_uor_to_pkgconfig_map_${uor_name}} PARENT_SCOPE)
    else()
...
function(bbs_pc_to_uor_name pc_name uor_name )
    bbs_assert_no_extra_args()
    if(DEFINED _bbs_pkgconfig_to_uor_map_${pc_name})
        set(${uor_name} ${_bbs_pkgconfig_to_uor_map_${pc_name}} PARENT_SCOPE)
    else()
