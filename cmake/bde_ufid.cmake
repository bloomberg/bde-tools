    ...
    if(NOT UFID)
        if(CMAKE_BUILD_TYPE)
            if(CMAKE_BUILD_TYPE STREQUAL "Release")
                message(STATUS  "Setting 'Release' to UFID to 'opt_exc_mt'.")
                set(UFID "opt_exc_mt" CACHE STRING "UFID for the project")
            endif()
            if(CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo")
                message(STATUS  "Setting 'RelWithDebInfo' to UFID to 'opt_dbg_exc_mt'.")
                set(UFID "opt_dbg_exc_mt" CACHE STRING "UFID for the project")
            endif()
            if(CMAKE_BUILD_TYPE STREQUAL "Debug")
                message(STATUS  "Setting 'Debug' to UFID to 'dbg_exc_mt'.")
                set(UFID "dbg_exc_mt" CACHE STRING "UFID for the project")
            endif()
        else()
            message(WARNING "Nor CMAKE_BUILD_TYPE nor UFID is defined.")
            message(STATUS  "Setting default UFID to 'opt_exc_mt'.")
            set(UFID "opt_exc_mt" CACHE STRING "UFID for the project")
        endif()
        if(BUILD_BITNESS)
            if (BUILD_BITNESS EQUAL "64")
                STRING(APPEND UFID "_64")
            endif()
        endif()
    endif()
