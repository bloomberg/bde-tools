    ...
    if(NOT UFID)
        if(CMAKE_BUILD_TYPE)
            if(CMAKE_BUILD_TYPE STREQUAL "Release")
                message(STATUS  "Setting 'Release' to UFID to 'opt_mt_exc'.")
                set(UFID "opt_mt_exc" CACHE STRING "UFID for the project")
            endif()
            if(CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo")
                message(STATUS  "Setting 'RelWithDebInfo' to UFID to 'opt_dbg_mt_exc'.")
                set(UFID "opt_dbg_mt_exc" CACHE STRING "UFID for the project")
            endif()
            if(CMAKE_BUILD_TYPE STREQUAL "Debug")
                message(STATUS  "Setting 'Debug' to UFID to 'dbg_mt_exc'.")
                set(UFID "dbg_mt_exc" CACHE STRING "UFID for the project")
            endif()
        else()
