...
for package in $WORKSPACE/source/bde-{oss-,internal-,}tools $WORKSPACE/source/bde $WORKSPACE/source/bde-core $WORKSPACE/source/a-cdb2 $WORKSPACE/source/bde-{bb,bdx}
do \
    echo "    ================================"
