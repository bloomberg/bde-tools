...
regions of C++11 code and genearates a C++03 version of that code that
emulates the C++11 features. Currently, this program emulates
two constructs:
...
gets translated into the following output:

    #if BSLS_COMPILERFEATURES_SIMULATE_VARIADIC_TEMPLATES
    // {{{ BEGIN GENERATED CODE
    // Command line: sim_cpp11_features.pl
    void j() {
        g();
    }
